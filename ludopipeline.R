...
DIA_raw <- read_protti("data/20231005_111328_LiP_School_Lydia_SN18_directDIA_Report.tsv")
unique(DIA_raw$r_file_name)
annotation <- read.csv("data/20231005_111328_LiP_School_Lydia_SN18_directDIA_Report_SampleAnnotation.txt", sep = "\t")

proteome <- phylotools::read.fasta("data/190417_Human_sp_only_iRT_1liner.fasta") %>% janitor::clean_names() %>%
